      ...
      $data1=mysqli_fetch_assoc($find_one1);
            ...
            $tipe_gambar = 'image/JPG';
                        echo "<tr>
                            ...
                            <td>".$data['nama']."</td>
                                <td>
                                    <a href='index.php?title=view&page=detail&id=$data[id]'>
                            ...
                            <td>
                                    <a href='index.php?title=detail&page=detail&id=$data[id]' class='btn btn-outline-primary btn-sm'><i class='fas fa-eye'></i></a>
